...
class RideViewModel() : ViewModel() {
    ...
    fun getAddressFromLastLocation(mvm:MapViewModel) {
        viewModelScope.launch {
            originAddress.value = MarkerInfoBottomSheet.googleRepository.getAddressFromLatLng(
                Location(mvm.lastLocation.value!!.latitude, mvm.lastLocation.value!!.longitude)
            )
        }
    }
